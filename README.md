...
The consideration for the individual Clarion packages, is if as a developer have the correct Clarion version in your environment to use the templates or run the compiler.
